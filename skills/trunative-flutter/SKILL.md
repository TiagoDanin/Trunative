---
name: trunative-flutter
description: Design and review mobile app UI in Flutter. Use when building a screen, component, navigation flow, or form for a phone, or when reviewing existing mobile UI. Install this copy only in a Flutter project.
---
