---
name: trunative-expo
description: Design and review mobile app UI in Expo. Use when building a screen, component, navigation flow, or form for a phone, or when reviewing existing mobile UI. Install this copy only in a Expo project.
---
